<template>
    <div>
        <jb-breadcrumb @handleBack="currentView='recordList'" :hideBack="currentView=='recordList'">当前位置：申请记录 > 金融贷款{{breadcrumb}}</jb-breadcrumb>
        <!-- <div class="clearfix">
...
import addRecord from "../common/addRecord.vue";
export default {
    computed:{
      breadcrumb() {
