    ...
    <div v-show="willShow">
      <el-form :inline="true" :model="listQueryParam" size="small">
        ...
        <el-form-item label="活动ID：">
          <jb-eventMarket v-model="listQueryParam.eventMarketId"></jb-eventMarket>
        </el-form-item>
        ...
        <el-form-item label="平台类型：">
          <jb-platformType v-model="listQueryParam.userPlatform"></jb-platformType>
        </el-form-item>
        ...
        <el-form-item label="推广渠道：">
          <jb-promotionChannel v-model="listQueryParam.userChannel" :platformType="listQueryParam.userPlatform"></jb-promotionChannel>
        </el-form-item>
        <el-form-item label="二级渠道：">
          <jb-promotionChannelChild v-model="listQueryParam.promotionChannelChild" :promotionChannelId="listQueryParam.userChannel" ></jb-promotionChannelChild>
        </el-form-item>
      ...
      <el-table ref="multipleTable" @selection-change="handleSelectionChange" :row-key="'id'" :data="userList" stripe
        ...
        <el-table-column align="center" prop="MonthlySalary" label="月均收入（元）" width="120"
                         show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="PlatformType" label="平台类型" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="eventMarketId" label="活动ID" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="PromotionChannel" label="推广渠道" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="promotionChannelChild" label="二级渠道" show-overflow-tooltip></el-table-column>
...
<script>
  ...
  export default {
    ...
    watch:{
      listQueryParam:{
        deep:true,
        handler:function (listQueryParam) {
          if(listQueryParam.userPlatform==""){
            this.listQueryParam.userChannel="";
            this.listQueryParam.promotionChannelChild="";
          }
          if(listQueryParam.userChannel==""){
            this.listQueryParam.promotionChannelChild="";
          }
        }
      }
