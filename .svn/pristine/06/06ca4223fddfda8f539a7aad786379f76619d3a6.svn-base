<template>
  <div class="clearfix breadcrumb">
    ...
    <el-button type="primary" class="back" @click="$router.back()" v-show="$route.path!=='/activityList'">返回上一页
    </el-button>
      ...
      getBreadcrumb(route) {
        switch (route) {
          ...
          case "/activityList/channel/setChannel/add":
            ...
            break;
          case "/activityList/channel/secondChannel":
            this.breadcrumb = " > 渠道设置 > 二级渠道设置";
            break;
