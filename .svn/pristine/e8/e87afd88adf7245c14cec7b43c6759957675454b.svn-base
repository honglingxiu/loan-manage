<template>
  <div>
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" @click="getBusinessList(1)">查询</el-button>
    ...
    <div class="mg15 mg-r0 pull-right" v-show="totalCount>0">
      <jb-pagination @getList="getBusinessList" :pageIndex="pageIndex" :pageSize="pageSize" :totalCount="totalCount"></jb-pagination>
    </div>
