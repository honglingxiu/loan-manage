	...
	<div>
		...
		<div v-show="willShow">
			<div class="mg15 mg-l0">
				...
				<span>回复状态</span>
				<el-select v-model="reply" placeholder="全部" class="select mg-r10" size="small" @change="getFilterCondition">
					<el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
					</el-option>
				</el-select>
				<el-button type="primary" size="small" icon="search" @click="querySuggest">查询</el-button>
			</div>
