<template>
  <div>
    <el-form :model="formData" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" @click="getRulesList(1)">查询</el-button>
    ...
    <div class="mg15 mg-r0 pull-right" v-show="formData.totalCount>0">
      <jb-pagination @getList="getRulesList" :pageIndex="formData.pageIndex" :pageSize="formData.pageSize" :totalCount="formData.totalCount"></jb-pagination>
    </div>
    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" width="600px" center>
      <el-form :model="dialogForm" :rules="rules" ref="ruleForm" label-width="100px">
        <el-form-item label="规则名称：" prop="ruleName">
          <el-input v-model.trim="dialogForm.ruleName" placeholder="请输入规则名称" class="width300"></el-input>
        </el-form-item>
        <el-form-item label="业务类型：" prop="businessTypeId">
          <jb-businessTypes v-model="dialogForm.businessTypeId"></jb-businessTypes>
        </el-form-item>
        <el-form-item label="说明：" prop="description">
          <el-input type="textarea" v-model.trim="dialogForm.description" placeholder="请输入说明信息" :rows="6"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer">
