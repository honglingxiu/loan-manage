<template>
    <div>
        ...
        <div class="mg15 mg-r0 pull-right" v-show="totalCount>0">
            <jb-pagination @getList="getRulesItemsList" :pageIndex="pageIndex" :pageSize="pageSize" :totalCount="totalCount"></jb-pagination>
        </div>
        ...
        <el-dialog :title="title" :visible.sync="dialogVisible" width="600px">
            <el-form :model="dialogForm" label-width="100px" :rules="rules" ref="itemsForm">
                <el-form-item label="项次名称：" prop="itemContent">
                    <el-input v-model.trim="dialogForm.itemContent" placeholder="请输入项次名称" class="width300"></el-input>
                </el-form-item>
                <el-form-item label="分值：" prop="itemScore">
                    <el-input type="number" v-model.trim="dialogForm.itemScore" placeholder="请输入分值" class="width300"></el-input>
                </el-form-item>
                <el-form-item label="内容说明：" prop="description">
                    <el-input type="textarea" v-model.trim="dialogForm.description" placeholder="请输入内容说明" :rows="6"></el-input>
                </el-form-item>
            </el-form>
