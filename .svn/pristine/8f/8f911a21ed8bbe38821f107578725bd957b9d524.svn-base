    ...
    <fieldset class="fieldset">
      ...
      <el-tabs type="border-card">
        <el-tab-pane label="提交给客服">
          <el-table :data="detailData.customerServiceRecord" stripe tooltip-effect='light' border>
            ...
            <!--<el-table-column prop="jobType" label="工单类型" align='center' :show-overflow-tooltip='true'>
                <template slot-scope="scope">
                    <span v-if="scope.row.jobType === '0'">确认信息</span>
                    <span v-else>补充信息</span>
                </template>
            </el-table-column>-->
            <el-table-column prop="businessName" label="业务类型" :show-overflow-tooltip='true'>
            </el-table-column>
            ...
            <el-table-column prop="noteName" label="查看" align='center'>
              <template slot-scope="scope">
        ...
        <el-tab-pane label="提交给客户">
          <el-table :data="detailData.customerRecord" stripe tooltip-effect='light' border>
            <el-table-column prop="createDate" label="提交时间" align='center'
                             :show-overflow-tooltip='true'></el-table-column>
