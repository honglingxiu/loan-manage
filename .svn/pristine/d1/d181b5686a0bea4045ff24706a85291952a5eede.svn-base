<template>
	<div>
        ...
        <el-table-column label="序号" align='center' type="index"
			...
			<div class="block">
        <jb-pagination @getList="getAdList" :pageIndex="pageIndex" :pageSize="pageSize" :totalCount="totalCount"></jb-pagination>
			</div>
		</div>
...
export default {
	...
	data: function() {
		return {
			...
			showEditPage:false,
			value: '',
			advertisName:"全部",//广告位置
			OnlineState:'2',//上下线状态，2：全部，0：上线，1：下线
			adList:[],
	...
	methods: {
		...
		getAdList:function(pageIndex,pageSize){//获取广告列表
